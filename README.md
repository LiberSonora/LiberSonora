...
项目主页和详细文档：[https://libersonora.github.io/](https://libersonora.github.io/)
...
项目的愿景是打造一个全方位的有声书生态系统，目前仅实现第一期功能，后续会根据社区反馈逐步完善和实现更多功能：

## 🎯 第一期：智能字幕提取、标题生成与多语言支持（已完成）

🎯 解决的核心问题：
- 📁 智能重命名：摆脱"第001集_xxxx.mp3"、"Chapter_001.mp3"等无意义命名，可被自动优化为 "第001集_桃园结义"、"Chapter_001_葫芦官判葫芦案"等有意义命名，轻松找到感兴趣的内容
